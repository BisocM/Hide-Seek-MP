...
I.strings = I.strings or {
	en = {
		...
		["hs.settings.teamRotation.label"] = "Team rotation",
		["hs.settings.teamRotation.info"] = "How teams are reassigned between rounds.",
		["hs.settings.teamRotation.swap"] = "Swap",
		["hs.settings.teamRotation.shuffle"] = "Shuffle",
	...
	ru = {
		...
		["hs.settings.teamRotation.label"] = "Ротация команд",
		["hs.settings.teamRotation.info"] = "Как команды перераспределяются между раундами.",
		["hs.settings.teamRotation.swap"] = "Обмен",
		["hs.settings.teamRotation.shuffle"] = "Случайно",
